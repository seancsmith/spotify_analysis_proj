...
```{r}
model_4_final <- glm(is_popular ~ loudness + explicit + danceability + energy + no_of_artists,
             family = "binomial",
             data = train_log_mod)
...
model_60_70_80 <- glm(is_popular ~ loudness + explicit + danceability + no_of_artists + energy,
             family = "binomial",
             data = log_mod_1960)
...
model_90_00_10 <- glm(is_popular ~ loudness + explicit + danceability + no_of_artists + energy,
             family = "binomial",
             data = log_mod_1990)
...
roc_curve <- ggroc(
  data = list(
    mod4 = roc_obj_mod4,
    mod_60_70_80 = roc_obj_mod_60_70_80,
    mod_90_00_10 = roc_obj_mod_90_00_10
  ), 
  legacy.axes = TRUE) +
  coord_fixed()
